...
Started: 2026-09-16 19:47:30 UTC


## No camera or Curr

- **only_up_no_camera_or_curr** — completed
  - camera=false, curriculum=false, multi_task=false, single_cmd=up, task_subset=-, num_envs=1024
...
- **only_left_no_camera_or_curr** — completed
  - camera=false, curriculum=false, multi_task=false, single_cmd=left, task_subset=-, num_envs=1024
...
- **only_right_no_camera_or_curr** — completed
  - camera=false, curriculum=false, multi_task=false, single_cmd=right, task_subset=-, num_envs=1024
...
- **only_down_no_camera_or_curr** — completed
  - camera=false, curriculum=false, multi_task=false, single_cmd=down, task_subset=-, num_envs=1024
...
- **all_no_camera_or_curr** — completed
  - camera=false, curriculum=false, multi_task=true, single_cmd=-, task_subset=-, num_envs=1024
...
- **only_up_no_camera** — completed
  - camera=false, curriculum=true, multi_task=false, single_cmd=up, task_subset=-, num_envs=1024
...
- **only_left_no_camera** — completed
  - camera=false, curriculum=true, multi_task=false, single_cmd=left, task_subset=-, num_envs=1024
...
- **only_right_no_camera** — completed
  - camera=false, curriculum=true, multi_task=false, single_cmd=right, task_subset=-, num_envs=1024
...
- **only_down_no_camera** — completed
  - camera=false, curriculum=true, multi_task=false, single_cmd=down, task_subset=-, num_envs=1024
...
- **only_up_no_curr** — FAILED (exit 137)
...
- **only_left_no_curr** — FAILED (exit 137)
...
- **left_up_no_curr** — FAILED (exit 137)
  - camera=true, curriculum=false, multi_task=true, single_cmd=-, task_subset=left,up, num_envs=64
...
- **up_down_no_curr** — FAILED (exit 137)
...
- **only_up_all_on** — FAILED (exit 137)
...
- **only_left_all_on** — FAILED (exit 137)
...
- **all_all_on** — FAILED (exit 137)
  ...
  - log: `ablation_logs/all_all_on.log`

## Task subset

- **left_up_all_on** — FAILED (exit 137)
  - camera=true, curriculum=true, multi_task=true, single_cmd=-, task_subset=left,up, num_envs=64
  - run: https://wandb.ai/models-imperial-college-london6785/RL%20for%20Games/runs/7n6ykkk6
  - log: `ablation_logs/left_up_all_on.log`
- **up_down_all_on** — FAILED (exit 137)
  ...
  - log: `ablation_logs/up_down_all_on.log`

Finished: 2026-09-17 17:08:37 UTC
